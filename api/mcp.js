...
export default function handler(request, response) {
  try {
    ...
    // Fail securely on unexpected internal exceptions, preventing stack trace exposure or serverless crashes (CWE-209)
    globalThis.console.error("MCP handler error:", err)
