...
export const locomotionPresentation = (fighter: FighterRuntime): LocomotionPresentation => {
  ...
  // Math.hypot dynamically scales inputs to handle overflow/underflow, which is completely unnecessary
  // for small, bounded coordinate spaces in active animation presentation.
