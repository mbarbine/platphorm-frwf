...
export const POSES: Readonly<Record<AnimationKey, Pose>> = {
  ...
  // Roll the raised arms toward the centerline. The old signs flared both
  // glove colliders away from the face and left an unobstructed chest lane.
  ...
  pin: { ...base, torso: [.88, 0, 0], leftArm: [-.44, -.18, -.38], rightArm: [-.5, .12, .32], leftForearm: [-1.08, 0, -.18], rightLeg: [.68, 0, .1], rightShin: [-1.45, 0, 0], leftLeg: [.3, 0, -.08], rootY: -.5, rootTilt: .58 },
  kickout: { ...base, torso: [-.55, 0, 0], leftArm: [-2.48, 0, -.5], rightArm: [-2.48, 0, .5], leftLeg: [1.48, 0, -.15], rightLeg: [1.48, 0, .15], leftShin: [-.98, 0, 0], rightShin: [-.98, 0, 0], rootY: -.28, rootTilt: -1.25 },
