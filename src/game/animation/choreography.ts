...
const SLAM_ACTOR: readonly PoseKeyframe[] = [
  ...
  { at: .6, pose: pose({ torso: [-.05, 0, 0], leftArm: [-1.72, -.22, -.35], rightArm: [-1.72, .22, .35], leftForearm: [-.85, 0, 0], rightForearm: [-.85, 0, 0], leftLeg: [-.1, 0, -.08], rightLeg: [-.1, 0, .08], leftShin: [-.2, 0, 0], rightShin: [-.2, 0, 0], rootY: 0, rootTilt: .02 }) },
