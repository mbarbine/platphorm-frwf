...
export const WORLD_ENCOUNTERS: readonly WorldEncounter[] = [
  ...
  { id: 'bash', title: 'Britt’s barnstormer', host: 'britt', position: { x: -18, z: 2 }, description: 'Britt Bash brings close-range pressure to the backyard. Win a bout to unlock this challenge.', difficulty: 'normal', rules: 'chaos', region: 'showground', venue: 'yard', requiredVictories: 1 },
