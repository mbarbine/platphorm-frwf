...
export const WORLD_ENCOUNTERS: readonly WorldEncounter[] = [
  { id: 'whiplash', title: 'Chelsea’s counter clinic', host: 'chelsea', position: { x: -7, z: 8 }, description: 'Chelsea Whiplash tests your timing outdoors. Guard the opening strike and answer with a counter.', difficulty: 'normal', rules: 'standard', region: 'showground', venue: 'yard' },
  { id: 'bash', title: 'Anastasia’s barnstormer', host: 'britt', position: { x: -18, z: 2 }, description: 'Anastasia Britt brings close-range pressure to the backyard. Win a bout to unlock this challenge.', difficulty: 'normal', rules: 'chaos', region: 'showground', venue: 'yard', requiredVictories: 1 },
  { id: 'bandit-bill', title: 'Bill’s hardware heist', host: 'beer_bandit_bill', position: { x: 8, z: 19 }, description: 'Take on Beer Bandit Bill in a singles Chaos Circuit bout. Find a chair and make your opening count.', difficulty: 'easy', rules: 'chaos', region: 'showground', venue: 'underground' },
  { id: 'bandit-ted', title: 'Ted’s last call', host: 'beer_bandit_ted', position: { x: -2, z: -10 }, description: 'Beer Bandit Ted waits below the grounds. A harder singles encounter with the second Beer Bandit.', difficulty: 'hard', rules: 'chaos', region: 'showground', venue: 'underground', requiredVictories: 2 },
  ...
  { id: 'main-event', title: 'The Claw’s open challenge', host: 'chad', position: { x: 11, z: -2.5 }, description: 'A full Singles match in the FRWF Arena. Win here to earn your first main-event victory.', difficulty: 'normal', rules: 'standard', region: 'ringside', venue: 'dome' },
  ...
  { id: 'championship', title: 'Showground championship', host: 'chad', position: { x: 19, z: -19 }, description: 'The circuit finale: The Claw, hard difficulty, full Singles wrestling in FRWF Arena. Earn three distinct encounter victories to enter.', difficulty: 'hard', rules: 'standard', region: 'ringside', venue: 'dome', requiredVictories: 3 },
];
