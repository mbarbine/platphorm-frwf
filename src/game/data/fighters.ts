...
export const FIGHTERS: readonly FighterDefinition[] = [
  {
    ...
    physics: { massKg: 126, standingHeightM: 1.96, shoulderWidthM: .61, hipWidthM: .39, armLength: 1.04, legLength: 1.02, torsoLength: 1.08, centerOfMassBias: -.07, reachM: 2.01, muscleStrength: .98, gripStrength: .91, balanceRecovery: .68, jointStiffness: .94 },
  ...
  },
  {
    ...
    physics: { massKg: 91, standingHeightM: 1.88, shoulderWidthM: .5, hipWidthM: .36, armLength: 1.06, legLength: 1.04, torsoLength: 1, centerOfMassBias: -.02, reachM: 1.96, muscleStrength: .79, gripStrength: .98, balanceRecovery: .99, jointStiffness: .96 },
  ...
  },
  {
    ...
    physics: { massKg: 103, standingHeightM: 1.9, shoulderWidthM: .55, hipWidthM: .38, armLength: 1.02, legLength: 1.01, torsoLength: 1.03, centerOfMassBias: -.04, reachM: 1.93, muscleStrength: .87, gripStrength: .84, balanceRecovery: .82, jointStiffness: .86 },
