...
const BASE_MOVES: Readonly<Record<string, MoveDefinition>> = {
  ...
  combo: { id: 'combo', displayName: 'Lead Cross', category: 'quick', requiredActorStates: active, minimumRange: 0, maximumRange: 1.42, staminaCost: 8, momentumGain: 9, damage: 7, anticipationDuration: .11, activeDuration: .25, recoveryDuration: .26, knockback: .7, knockdownStrength: .08, counterWindow: null, hypeValue: 4, animationKey: 'jab' },
  ...
  uppercut: { id: 'uppercut', displayName: 'Voltage Uppercut', category: 'heavy', requiredActorStates: active, requiredTargetStates: allStanding, minimumRange: .15, maximumRange: 1.65, staminaCost: 15, momentumGain: 15, damage: 15, anticipationDuration: .3, activeDuration: .24, recoveryDuration: .34, knockback: 1.35, knockdownStrength: .55, counterWindow: [.08, .18], hypeValue: 11, animationKey: 'heavyStrike' },
  headbutt: { id: 'headbutt', displayName: 'Hardline Headbutt', category: 'quick', requiredActorStates: active, requiredTargetStates: allStanding, minimumRange: 0, maximumRange: 1.18, staminaCost: 9, momentumGain: 11, damage: 9, anticipationDuration: NETWORK_MOVE_TIMING.headbutt.anticipation, activeDuration: NETWORK_MOVE_TIMING.headbutt.active, recoveryDuration: NETWORK_MOVE_TIMING.headbutt.recovery, knockback: .72, knockdownStrength: .2, counterWindow: [.07, .16], hypeValue: 8, animationKey: 'heavyStrike' },
  low_kick: { id: 'low_kick', displayName: 'Circuit Low Kick', category: 'heavy', requiredActorStates: active, requiredTargetStates: allStanding, minimumRange: .25, maximumRange: 2.05, staminaCost: 8, momentumGain: 10, damage: 8, anticipationDuration: NETWORK_MOVE_TIMING.low_kick.anticipation, activeDuration: NETWORK_MOVE_TIMING.low_kick.active, recoveryDuration: NETWORK_MOVE_TIMING.low_kick.recovery, knockback: .55, knockdownStrength: .24, counterWindow: null, hypeValue: 6, animationKey: 'kick' },
  high_kick: { id: 'high_kick', displayName: 'Halo High Kick', category: 'heavy', requiredActorStates: active, requiredTargetStates: allStanding, minimumRange: .35, maximumRange: 2.35, staminaCost: 16, momentumGain: 16, damage: 16, anticipationDuration: .26, activeDuration: .32, recoveryDuration: .42, knockback: 1.5, knockdownStrength: .68, counterWindow: [.09, .22], hypeValue: 13, animationKey: 'kick' },
  ...
  front_kick: { id: 'front_kick', displayName: 'Piston Boot', category: 'heavy', requiredActorStates: active, requiredTargetStates: allStanding, minimumRange: .25, maximumRange: 2.18, staminaCost: 14, momentumGain: 14, damage: 14, anticipationDuration: .22, activeDuration: .30, recoveryDuration: .36, knockback: 1.7, knockdownStrength: .58, counterWindow: [.08, .18], hypeValue: 11, animationKey: 'kick' },
  ground: { id: 'ground', displayName: 'Ground Stomp', category: 'ground', requiredActorStates: active, requiredTargetStates: ['downed'], minimumRange: 0, maximumRange: 1.8, staminaCost: 10, momentumGain: 8, damage: 8, anticipationDuration: .22, activeDuration: .12, recoveryDuration: .28, knockback: .2, knockdownStrength: .1, counterWindow: null, hypeValue: 5, animationKey: 'kick' },
  ground_punch: { id: 'ground_punch', displayName: 'Ground Hammerfist', category: 'ground', requiredActorStates: active, requiredTargetStates: ['downed'], minimumRange: 0, maximumRange: 1.5, staminaCost: 7, momentumGain: 7, damage: 6, anticipationDuration: .3, activeDuration: .22, recoveryDuration: .32, knockback: .15, knockdownStrength: 0, counterWindow: null, hypeValue: 5, animationKey: 'jab' },
  ...
  slam: { id: 'slam', displayName: 'Voltage Slam', category: 'grapple', requiredActorStates: active, requiredTargetStates: allStanding, minimumRange: 0, maximumRange: 1.28, staminaCost: 19, momentumGain: 17, damage: 16, anticipationDuration: NETWORK_MOVE_TIMING.slam.anticipation, activeDuration: NETWORK_MOVE_TIMING.slam.active, recoveryDuration: NETWORK_MOVE_TIMING.slam.recovery, knockback: 1.1, knockdownStrength: 1, counterWindow: [.24, .82], hypeValue: 11, animationKey: 'slam' },
  ...
  grapple_miss: { id: 'grapple_miss', displayName: 'Collar Reach', category: 'utility', requiredActorStates: active, minimumRange: 0, maximumRange: 99, staminaCost: 0, momentumGain: 0, damage: 0, anticipationDuration: NETWORK_MOVE_TIMING.grapple_miss.anticipation, activeDuration: NETWORK_MOVE_TIMING.grapple_miss.active, recoveryDuration: NETWORK_MOVE_TIMING.grapple_miss.recovery, knockback: 0, knockdownStrength: 0, counterWindow: null, hypeValue: 0, animationKey: 'grappleEntry' },
