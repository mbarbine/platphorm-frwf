  ...
  useEffect(() => {
    ...
    const handleKeyDown = (event: KeyboardEvent) => {
      ...
      if (nextFighter) {
        ...
        setTimeout(() => {
          const element = document.querySelector(`[data-fighter-select-id="${nextFighter.id}"]`) as HTMLButtonElement | null;
          if (element) {
            element.focus();
          }
        }, 0);
