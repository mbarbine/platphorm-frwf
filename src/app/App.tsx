...
export function App() {
  ...
  return <main className={`app app--${screen}`}>
    ...
    {screen === 'how' && <section className="panel panel--how"><div className="section-heading"><span>CORNER COACH</span><h2>HOW TO PLAY</h2></div><div className="how-grid">
      <article><b>1 · CONTROL THE SPACE</b><p>Move with WASD, stick, D-pad, or the mobile joystick. Hold Shift, RT, or RUN to sprint. Movement is camera-relative and diagonals stay consistent.</p></article><article><b>2 · WRESTLE, DON'T MASH</b><p>Press L, B, or LOCK to grapple. Hold a direction and choose quick, power, or grapple for a different takedown, slam, throw, whip, or power move.</p></article><article><b>3 · LOAD THE ROPES</b><p>Sprint into a rope to stretch it, rebound, and press heavy/POWER for a Railway Stiff-Arm. The harder entry creates the faster return.</p></article><article><b>4 · OWN THE CORNERS</b><p>Move into a corner and press F, R3, or ACTION to climb the turnbuckle. Press it again to launch a Domefall Dive at your rival.</p></article><article><b>5 · GUARD & REVERSE</b><p>Hold I, LT, or GUARD to block. Tap Space, A, or COUNTER during the warning window. Fill Momentum, then use the context action to finish or pin.</p></article><article><b>TOUCH & GAMEPAD</b><p>Touch controls support simultaneous movement, running, guarding, and attacks. Gamepad: RT run · X quick · Y power · B grapple · LT guard · A counter · R3 context.</p></article>
