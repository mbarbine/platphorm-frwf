...
export function App() {
  ...
  return <main className={`app app--${screen}`}>
    ...
    {screen === 'how' && <section className="panel panel--how"><div className="section-heading"><span>CORNER COACH</span><h2>HOW TO PLAY</h2></div><div className="how-grid">
      <article><b>1 · CONTROL THE SPACE</b><p>Move with WASD, stick, D-pad, or the mobile joystick. Hold Shift, RT, or RUN to sprint. Tap C, L3, or JUMP for a physical standing jump.</p></article><article><b>2 · WRESTLE, DON'T MASH</b><p>Press L, B, or LOCK to make a two-hand grapple. While locked up, hold a direction and choose J, K, or L for a takedown, slam, throw, whip, or power move.</p></article><article><b>3 · LOAD THE ROPES</b><p>Sprint into a rope to stretch it and rebound. Press K, Y, or POWER during the glowing rebound window for the Railway Stiff-Arm.</p></article><article><b>4 · OWN THE CORNERS</b><p>Reach a corner and press F, R3, or ACTION three times to climb bottom, middle, and top. From the top, press Q/RB to pose or F/R3 to launch a Domefall Dive.</p></article><article><b>5 · GUARD & REVERSE</b><p>Hold I, LT, or GUARD to block. Tap Space, A, or COUNTER during the warning window. Fill Momentum, then use F, R3, or ACTION to finish or pin.</p></article><article><b>LIVE CONTROL DECK</b><p>The match HUD now shows every control at all times. The active command lights up and the broadcast callout tells you when ropes, climbs, dives, pins, and finishers are available.</p></article>
