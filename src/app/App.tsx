...
export function App() {
  ...
  return <main className={`app app--${screen}${toyTest ? ' app--toy-test' : ''}`}>
    ...
    {screen === 'init' && <section className="init-screen"><Logo /><div className="init-card"><span>FRWF / TURKEY FARM</span><b>TURKEY DOME READY</b><small>Backyard wrestling · barnyard chaos</small></div><button className="button button--hero" onClick={enter}>ENTER RINGFALL</button><p>Step into the ring. Make it unforgettable.</p></section>}
