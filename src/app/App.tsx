...
export function App() {
  ...
  return <main className={`app app--${screen}`}>
    ...
    {screen === 'how' && <section className="panel panel--how"><div className="section-heading"><span>CORNER COACH</span><h2>HOW TO PLAY</h2></div><div className="how-grid">
      <article><b>1 · CONTROL THE SPACE</b><p>Move with WASD. Hold Shift to run. Touch a rope at speed to rebound into a harder strike.</p></article><article><b>2 · BUILD A STORY</b><p>J strings quick attacks. K hits hard. L cycles slams, throws, takedowns, and Irish whips. Variety builds Momentum and Hype.</p></article><article><b>3 · READ THE FLASH</b><p>Major attacks telegraph. Tap Space inside the finite window to reverse; outside it, Space performs a dodge.</p></article><article><b>4 · CLOSE THE SHOW</b><p>At full Momentum, stagger or drop your rival and press F for a signature. Press F over a downed rival to pin.</p></article><article><b>CHAOS CIRCUIT</b><p>Use E near a chair or sign, then K or E to swing it. Broadcast events alter props, ropes, lighting, or Momentum.</p></article><article><b>GAMEPAD</b><p>Stick move · RT run · X quick · Y heavy · B grapple · A counter · LB prop · RB taunt · R3 context.</p></article>
