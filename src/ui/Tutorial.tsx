...
export function Tutorial() {
  ...
  return <aside className="tutorial"><div><span>60-SECOND CORNER COACH</span><button aria-label="Close tutorial" onClick={close}>×</button></div><ul>
    <li><kbd>WASD</kbd><span>MOVE</span></li><li><kbd>J</kbd><span>QUICK</span></li><li><kbd>K</kbd><span>HEAVY</span></li><li><kbd>L + DIR</kbd><span>GRAPPLE CHAIN</span></li><li><kbd>I</kbd><span>HOLD GUARD</span></li><li><kbd>SPACE</kbd><span>DODGE / COUNTER</span></li><li><kbd>F</kbd><span>PIN / FINISHER</span></li>
