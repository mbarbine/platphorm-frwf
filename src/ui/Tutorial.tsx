...
export function Tutorial({ device }: { device: ControlDevice }) {
  ...
  return <aside className={`tutorial${touch ? ' tutorial--touch' : ''}`}><div><span>10-SECOND CORNER COACH</span><button aria-label="Close tutorial" onClick={close}>×</button></div><ul>
    {touch ? <><li><kbd>STICK</kbd><span>MOVE · RUN</span></li><li><kbd>JAB</kbd><span>PUNCH</span></li><li><kbd>HIT</kbd><span>KICK</span></li><li><kbd>LOCK</kbd><span>GRAB</span></li><li><kbd>↯</kbd><span>DODGE</span></li><li><kbd>ACTION</kbd><span>CONTEXT</span></li></> : <><li><kbd>WASD</kbd><span>MOVE · SHIFT SPRINT</span></li><li><kbd>J</kbd><span>PUNCH</span></li><li><kbd>K</kbd><span>KICK</span></li><li><kbd>L</kbd><span>GRAB</span></li><li><kbd>C</kbd><span>JUMP</span></li><li><kbd>SPACE</kbd><span>DODGE / COUNTER</span></li><li><kbd>I</kbd><span>GUARD (HOLD)</span></li><li><kbd>F</kbd><span>PIN / SPECIAL</span></li></>}
