...
const MAIN_EVENT_CALLS = /^(ONE|TWO|THREE|KNOCKOUT!|THREE!)$|COMMENTARY DESK — WRECKED|\.9 — KICKOUT|VOLTAGE PILEDRIVER|DOME POWERBOMB|SKYHOOK SUPLEX|HURLED|UNSTOPPABLE!|PIN REVERSAL!/;
