...
const ROUTINE_CALLS = /CROWD CALL|THROUGH THE ROPES|BACK BETWEEN THE ROPES|AIR MAIL|GRIP DENIED|GRIP BROKEN|DESK BUCKLES/;
const MAIN_EVENT_CALLS = /^(ONE|TWO|THREE|KNOCKOUT!|THREE!)$|COMMENTARY DESK — WRECKED|\.9 — KICKOUT/;
