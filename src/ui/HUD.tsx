...
export function HUD({ device, paused }: { device: ControlDevice; paused: boolean }) {
  ...
  const playerRightForearm = bodyWorksRuntime.segmentSnapshot('player', 'rightForearm')?.position; const opponentChest = bodyWorksRuntime.segmentSnapshot('opponent', 'chest')?.position;
