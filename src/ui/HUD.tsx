...
export function HUD({ device, paused }: { device: ControlDevice; paused: boolean }) {
  ...
  const controlReadout = buildControlReadout(model.player, target, playerPhysics.speed, distance, paused, activeDevice, combatDirectionInput, playerIntent.run, controlStyle, venueFor(model).hasRing);
