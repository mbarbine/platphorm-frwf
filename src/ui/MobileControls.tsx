...
export function MobileControls({ onPause, paused }: MobileControlsProps) {
  ...
  // OPTIMIZATION: Replacing slow Math.hypot with standard Math.sqrt for mobile UI distance calculation.
  ...
  const moveStick = (clientX: number, clientY: number): void => {
    ...
    // OPTIMIZATION: Replacing Math.hypot with zero-allocation squared check and Math.sqrt.
