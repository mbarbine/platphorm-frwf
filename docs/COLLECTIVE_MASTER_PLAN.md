...
Platform impact: this repair preserves existing public routes, discovery files, auth boundaries and trace/span behavior. No cross-site integration or backend cutover was added or certified. Network-wide standardization still requires separate per-site verification. Production alias inspection before release showed the older 01:28 EDT deployment; final release evidence must be recorded after promotion and canonical-host checks.
